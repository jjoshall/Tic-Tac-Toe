...
int main()
{
    ...
    do
    {
        ...
        //If game is not over, let player 2 have a turn
...
//The displayBoard function shows the contents of the board
...
//The playerTurn function allows a player to take a turn
void playerTurn(char board[][COLS], char symbol)
{
    //inAvailable flag is set to true when the player selects a location on the board that is available
...
//The gameOver function returns true if the game is over.
//This is the case when either player has already won, or there is a tie.
bool gameOver(char board[][COLS])
{
    ...
    //Otherwise, it is a tie. Game over.
    else
        status = true;
